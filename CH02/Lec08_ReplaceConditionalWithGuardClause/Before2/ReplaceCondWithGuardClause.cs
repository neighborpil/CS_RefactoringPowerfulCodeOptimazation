...
namespace ReplaceCondWithGuardClause
{
    ...
    class BonusCalculator
    {
        ...
        public float CalculateBonus(IEnumerable<Employee> employees, string employeeName)
        {
            ...
            //    if (employee != null)
            //    {
            //        var passedDays = (DateTime.Today - employee.LastBonusDate).Days;
            //        if (passedDays > 150)
            //        {
            //            passedDays = (DateTime.Today - employee.HireDate).Days;
            //            var workedYears = passedDays / 365;
            //            var coefficient = CalculateBonusCoefficient(workedYears);
            //            if (coefficient > 0)
            //                return employee.Salary * coefficient;
            //        }
            //    }
            //}
            //return zeroBonus;
            ...
            var daysAfterLastBonus = (DateTime.Today - employee.LastBonusDate).Days;
            if (daysAfterLastBonus <= 150)
                return zeroBonus;
